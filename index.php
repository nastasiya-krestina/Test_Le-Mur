...
<body>
    ...
    <section class="hero">
        <div class="container hero__container">
            <div class="hero__title-mission">
                <svg class="hero__title-mission-marker" width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 0H14C21.732 0 28 6.26801 28 14H14C6.26801 14 0 7.73199 0 0Z" fill="white"/>
                </svg>
                <h3 class="hero__title-mission-text">
                    Укрепление здоровья
                </h3>
    ...
    <section class="sessions">
        <div class="container sessions__container">
            <div class="title sessions__title">
                ...
                <h2 class="heading sessions__heading">
                    Сеансы RitmStyle
                </h2>
                <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="sessions__card sessions__card-one">
                <h3 class="sessions__text">
                    Стандартный RitmStyle
                </h3>
            </div>
            <div class="sessions__card sessions__card-two">
                <h3 class="sessions__text">
                    RitmStyle для пар
                </h3>
            </div>
            <div class="sessions__card sessions__card-three">
                <h3 class="sessions__text">
                    RitmStyle с полным погружением под воду
                </h3>
            </div>
            <div class="sessions__card sessions__card-four">
                <h3 class="sessions__text">
                    RitmStyle для беременных
                </h3>
            </div>
            <div class="sessions__card sessions__card-five">
                <h3 class="sessions__text">
    ...
    <section class="reviews">
        <div class="container reviews__container">
            <div class="title reviews__title">
                ...
                <h2 class="heading reviews__heading">
                    Отзывы
                </h2>
                <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M28 0H14C6.26801 0 0 6.26801 0 14H14C21.732 14 28 7.73199 28 0Z" fill="#018ABE"/>
            ...
            <div class="swiper">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        ...
                        <p class="reviews__card-text reviews__card-text-last">
    ...
    <section class="about">
        <div class="container about__container">
            ...
            <div class="about__item-one">
                <p class="about__item-title">
                    RitmStyle массаж 
                </p>
                <p class="about__item-text about__item-text-special">
            ...
            <div class="about__item-two">
                <div class="about__item-img">
                    <img src="img/cards.png" alt="RitmStyle массаж">
                </div>
            </div>
            <div class="about__item-three">
                <div class="about__item-img">
                    <img class="about__item-image" src="img/cards.png" alt="RitmStyle гидротерапия">
                </div>
            </div>
            <div class="about__item-four">
                <p class="about__item-title">
    ...
    <section class="price">
        <div class="container price__container">
            <div class="title price__title">
                ...
                <h2 class="heading price__heading">
                    Стоимость сеансов
                </h2>
                <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M28 0H14C6.26801 0 0 6.26801 0 14H14C21.732 14 28 7.73199 28 0Z" fill="#018ABE"/>
            ...
            <div class="price__left">
                <ul class="price__services-list">
                    <li class="price__services-item">
                        <svg class="price__services-marker" width="18" height="9" viewBox="0 0 18 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0H9C13.9706 0 18 4.02944 18 9V9H9C4.02944 9 0 4.97056 0 0V0Z" fill="#018ABE"/>
                        </svg>
                        <p class="price__services-text">
            ...
            <div class="price__center">
                <ul class="price__cost-list">   
                    <li class="price__cost-item">
                        <p class="price__cost-text">
                            1000р.
                        </p> 
                    </li>
                    <li class="price__cost-item">
            ...
            <div class="price__right">
                <div class="price__item-img">
                    <img class="price__img" src="img/price.png" alt="RitmStyle массаж">
                    <p class="price__img-text">
    ...
    <section class="navigation">
        <div class="container navigation__container">
            <div class="navigation__map">
                <div id="map" class="navigation__my-map">
                </div>
            </div>
            <ul class="navigation__list">
                <li class="navigation__card">
                    <h3 class="navigation__title">
                        Бассейн WorkClass
                    </h3>
                    <div class="navigation__card-contain">
                        <div class="navigation__item">
                            <svg class="navigation__marker" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="navigation__item">
                            <svg class="navigation__marker" width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button ctype="button" class="btn btn-primary btn-lg button navigation__button" data-toggle="modal" data-target="#myModal">
                        Записаться на сеанс
                    </button>
                </li>
                <li class="navigation__card">
